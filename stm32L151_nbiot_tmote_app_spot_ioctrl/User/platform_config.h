...
#define	IOCTRL_MODEL_DISABLE			0
#define	IOCTRL_MODEL_ENABLE				1
#define	IOCTRL_MODEL_TYPE				IOCTRL_MODEL_ENABLE					//IO控制
...
void Control_KEY1_ON(void);
void Control_KEY1_OFF(void);
void Control_KEY2_ON(void);
void Control_KEY2_OFF(void);
