...
#define	NETMQTTSNSKY					100								//SKY  MQTTSN
#define	NETMQTTSNUDP					200								//UDP  MQTTSN
#define	NETNEWPROTOCAL					NETMQTTSNSKY						//增加网络模式
...
#define	NETCARRIERTYPE					NETCARRIERCHINAMOBILE				//运营商
...
#define	RADIO_DOWNLOAD_CMD_UDPIP			1								//RADIO下行指令UDPIP
#define	RADIO_DOWNLOAD_CMD_ACTIVE		1								//RADIO下行指令Active
#define	RADIO_DOWNLOAD_CMD_MAGMOD		1								//RADIO下行指令MagMod
#define	RADIO_DOWNLOAD_CMD_NBHEART		1								//RADIO下行指令NbHeart
#define	RADIO_DOWNLOAD_CMD_MAGINIT		1								//RADIO下行指令MagInit
...
#define	MQTTSN_DOWNLOAD_CMD_UDPIP		1								//MQTTSN下行指令UDPIP
...
#define	TEST_SERVER_HOST_IP				"47.96.175.6"						//TEST服务器默认配置
#define	TEST_SERVER_LOCAL_PORT			3000
#define	TEST_SERVER_TELE_PORT			5678

#if NETNEWPROTOCAL == NETMQTTSNUDP											//AutoCtrl
#define	UDP_SERVER_HOST_IP				"120.76.100.206"
#define	UDP_SERVER_LOCAL_PORT			3000
#define	UDP_SERVER_TELE_PORT			8090
#endif
#if NETNEWPROTOCAL == NETMQTTSNSKY											//SkyNet
#define	UDP_SERVER_HOST_NAME			"router.cu-sc.com"
#define	UDP_SERVER_HOST_IP				"123.125.218.33"
#define	UDP_SERVER_LOCAL_PORT			3000
#define	UDP_SERVER_TELE_PORT			9961
#endif
