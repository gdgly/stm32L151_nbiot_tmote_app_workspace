...
#define	UDP_SERVER_HOST_IP				TEST_SERVER_HOST_IP					//UDP服务器默认配置
#define	UDP_SERVER_LOCAL_PORT			TEST_SERVER_LOCAL_PORT
#define	UDP_SERVER_TELE_PORT			TEST_SERVER_TELE_PORT
#endif
