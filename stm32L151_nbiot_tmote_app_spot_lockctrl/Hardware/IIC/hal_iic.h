...
#define IIC_SCL_PB6_SDA_PB7			0
#define IIC_SCL_PB7_SDA_PB6			1
#define IIC_SCL_SDA_TYPE				IIC_SCL_PB6_SDA_PB7

#if IIC_SCL_SDA_TYPE == IIC_SCL_PB6_SDA_PB7
...
#if IIC_SCL_SDA_TYPE == IIC_SCL_PB7_SDA_PB6
#define IIC_SCL_GPIOx				GPIOB
#define IIC_SDA_GPIOx				GPIOB
...
#if IIC_SCL_SDA_TYPE == IIC_SCL_PB7_SDA_PB6
#define SDA_IN()	{IIC_SDA_GPIOx->MODER&=~(3<<(6*2));IIC_SDA_GPIOx->MODER|=0<<6*2;}				//PB6输入模式
#define SDA_OUT()	{IIC_SDA_GPIOx->MODER&=~(3<<(6*2));IIC_SDA_GPIOx->MODER|=1<<6*2;}				//PB6输出模式
#endif
