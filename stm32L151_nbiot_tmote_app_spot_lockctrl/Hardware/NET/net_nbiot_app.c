...
void NET_NBIOT_DataProcessing(NET_NBIOT_ClientsTypeDef* pClient)
{
	...
	if (NETCTWingNeedSendCode.ShortStatus) {
		...
		CTWingShortStructure.SpotStatus					= ((MOTOR_SPOTLOCK_STATE() == SPOTLOCK_CTRL_FALL) ? (SpotStatusData.spot_status | (1 << 2)) : (SpotStatusData.spot_status & ~(1 << 2)));
	...
	if (NETCTWingNeedSendCode.LongStatus) {
		...
		CTWingLongStructure.SpotStatus					= ((MOTOR_SPOTLOCK_STATE() == SPOTLOCK_CTRL_FALL) ? (SpotStatusData.spot_status | (1 << 2)) : (SpotStatusData.spot_status & ~(1 << 2)));
	...
	if (NETCTWingNeedSendCode.LongStatus) {
		...
		AepSpotStatusSrcdata.SpotStatus					= ((MOTOR_SPOTLOCK_STATE() == SPOTLOCK_CTRL_FALL) ? (SpotStatusData.spot_status | (1 << 2)) : (SpotStatusData.spot_status & ~(1 << 2)));
