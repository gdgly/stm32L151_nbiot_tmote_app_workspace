...
#define OOK_KEY_ISLOCK_CODE1				0x0100
#define OOK_KEY_UNLOCK_CODE1				0x0400

#define OOK_KEY_ISLOCK_CODE2				0x0800
#define OOK_KEY_UNLOCK_CODE2				0x0400

#define OOK_KEY_ISLOCK_TYPE				OOK_KEY_ISLOCK_CODE2
#define OOK_KEY_UNLOCK_TYPE				OOK_KEY_UNLOCK_CODE2
