...
#define	NETDNS_SERVER_DISABLE			0
#define	NETDNS_SERVER_ENABLE			1
#define	NETDNS_SERVER_TYPE				NETDNS_SERVER_ENABLE				//DNS解析服务模式
...
#if NETDNS_SERVER_TYPE == NETDNS_SERVER_DISABLE
#define	NETFIFO_MQTTSNSENDPARKNUM_MAX		40								//NetMqttSN发送缓存最大包数
#define	NETFIFO_MQTTSNSENDPARKSIZE_MAX	3368								//NetMqttSN发送缓存大小
#endif
#if NETDNS_SERVER_TYPE == NETDNS_SERVER_ENABLE
...
#define	CTWING_AEPMODULE_DISABLE			0
#define	CTWING_AEPMODULE_ENABLE			1
#define	CTWING_AEPMODULE_MODE			CTWING_AEPMODULE_ENABLE				//CTWING物联网模型模式
...
#define	NBIOT_UPWARDSSLEEP_DISABLE		0
#define	NBIOT_UPWARDSSLEEP_ENABLE		1
#define	NBIOT_UPWARDSSLEEP_TYPE			NBIOT_UPWARDSSLEEP_ENABLE			//NBIOT正放休眠中间隔24小时发送数据

#define	NBIOT_DNWARDSSLEEP_DISABLE		0
#define	NBIOT_DNWARDSSLEEP_ENABLE		1
#define	NBIOT_DNWARDSSLEEP_TYPE			NBIOT_DNWARDSSLEEP_ENABLE			//NBIOT倒放休眠中间隔24小时发送数据
...
#define	PRODUCTTEST_READ_TYPE			PRODUCTTEST_READ_DISABLE				//测试点测试模式

#define	PRODUCTTEST_TIMEOUT_DISABLE		0
#define	PRODUCTTEST_TIMEOUT_ENABLE		1
#define	PRODUCTTEST_TIMEOUT_TYPE			PRODUCTTEST_TIMEOUT_DISABLE			//测试点超时退出测试
...
#define	ROLLINGOVER_WORKINFO_DISABLE		0
#define	ROLLINGOVER_WORKINFO_ENABLE		1
#define	ROLLINGOVER_WORKINFO_TYPE		ROLLINGOVER_WORKINFO_DISABLE			//翻转发送workinfo
...
#define	NBCOAP_EXCEED_MSGLEN_DISABLE		0
#define	NBCOAP_EXCEED_MSGLEN_ENABLE		1
#define	NBCOAP_EXCEED_MSGLEN_TYPE		NBCOAP_EXCEED_MSGLEN_DISABLE			//NBCOAP消息超过指定大小默认成功

#define	NBCOAP_EXCEED_MSGLEN_MAX			100								//NBCOAP消息指定大小

#define	MQTTSN_EXCEED_MSGLEN_DISABLE		0
#define	MQTTSN_EXCEED_MSGLEN_ENABLE		1
#define	MQTTSN_EXCEED_MSGLEN_TYPE		MQTTSN_EXCEED_MSGLEN_ENABLE			//MQTTSN消息超过指定大小默认成功

#define	MQTTSN_EXCEED_MSGLEN_MAX			100								//MQTTSN消息指定大小
...
#define	NBCOAP_DOWNLOAD_CMD_SETQMCCOEF	0								//NBCOAP下行指令SetQmcCoef
...
#define	MQTTSN_DOWNLOAD_CMD_SPOTLOCK		1								//MQTTSN下行指令SpotLock
...
#define	MQTTSN_DOWNLOAD_CMD_SETQMCCOEF	0								//MQTTSN下行指令SetQmcCoef
...
#define	CTWING_DOWNLOAD_CMD_SPOTLOCK		1								//CTWING下行指令SpotLock
...
#define	CTWING_DOWNLOAD_CMD_SETQMCCOEF	0								//CTWING下行指令SetQmcCoef
...
#if NETDNS_SERVER_TYPE == NETDNS_SERVER_DISABLE
#define	MQTTSN_DNS_SERVER_TYPE			MQTTSN_DNS_SERVER_DISABLE			//DNS服务状态
#endif
#if NETDNS_SERVER_TYPE == NETDNS_SERVER_ENABLE
