...
/* PA13, PA14 ==> SDW, PC13 ==> BEEP is all deinit */
...
#define NBIOT_POWER_GPIOx				GPIOH
#define NBIOT_POWER_PIN					GPIO_PIN_0
#define NBIOT_POWER_RCC_GPIO_CLK_ENABLE()	__HAL_RCC_GPIOH_CLK_ENABLE()
#define NBIOT_POWER_RCC_GPIO_CLK_DISABLE()	__HAL_RCC_GPIOH_CLK_DISABLE()
