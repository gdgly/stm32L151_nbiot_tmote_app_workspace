...
#define	SYSTEM_BOOTCOUNT_CNTYPE			SYSTEM_BOOTCOUNT_CLEAN								//重启次数清零

#define	SYSTEM_BOOTUPGRADE_CLOSE			0
#define	SYSTEM_BOOTUPGRADE_START			1
#define	SYSTEM_BOOTUPGRADE_TYPE			SYSTEM_BOOTUPGRADE_CLOSE								//启动进行升级
