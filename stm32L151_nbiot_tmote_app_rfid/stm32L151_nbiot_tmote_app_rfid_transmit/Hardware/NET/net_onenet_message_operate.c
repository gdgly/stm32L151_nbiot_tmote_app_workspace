...
/**********************************************************************************************************
 @Function			int NET_ONENET_Message_Operate_Creat_Json_RFID_Info(char* outBuffer)
 @Description			NET_ONENET_Message_Operate_Creat_Json_RFID_Info
 @Input				outBuffer
 @Return				Length
 @attention			!!<<< MaxLength 450Byte >>>!!
**********************************************************************************************************/
int NET_ONENET_Message_Operate_Creat_Json_RFID_Info(char* outBuffer)
{
	sprintf(outBuffer, 
		"{"
			"\"SN\":\"%08x\","
