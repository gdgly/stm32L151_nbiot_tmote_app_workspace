...
#define TCFG_EEPROM_CONFIG_PAGE3_OFFSET		0x0100

#define TCFG_FLOW_DETECTMODE_OFFSET		TCFG_EEPROM_CONFIG_PAGE3_OFFSET						//0x08080100
#define TCFG_FLOW_DETECTMODE_LENGTH		1												//DetectMode			工作模式
#define TCFG_FLOW_MEASUREFREQ_OFFSET		TCFG_FLOW_DETECTMODE_OFFSET + TCFG_FLOW_DETECTMODE_LENGTH	//0x08080101
#define TCFG_FLOW_MEASUREFREQ_LENGTH		1												//MeasureFreq			地磁扫描频率
#define TCFG_FLOW_CARINTHRE_OFFSET			TCFG_FLOW_MEASUREFREQ_OFFSET + TCFG_FLOW_MEASUREFREQ_LENGTH	//0x08080102
#define TCFG_FLOW_CARINTHRE_LENGTH			1												//carinThreshhold		车辆进入参数
#define TCFG_FLOW_CAROUTTHRE_OFFSET		TCFG_FLOW_CARINTHRE_OFFSET + TCFG_FLOW_CARINTHRE_LENGTH	//0x08080103
#define TCFG_FLOW_CAROUTTHRE_LENGTH		1												//caroutThreshhold		车辆离开参数

#define TCFG_FLOW_RECAL_NUM_OFFSET			TCFG_FLOW_CAROUTTHRE_OFFSET + TCFG_FLOW_CAROUTTHRE_LENGTH	//0x08080104
#define TCFG_FLOW_RECAL_NUM_LENGTH			1												//recalibrationOvernum	基准值更新阈值
#define TCFG_FLOW_RECAL_TIME_OFFSET		TCFG_FLOW_RECAL_NUM_OFFSET + TCFG_FLOW_RECAL_NUM_LENGTH	//0x08080105
#define TCFG_FLOW_RECAL_TIME_LENGTH		1												//recalibrationOvertime	背景值重新计算时间

#define TCFG_FLOW_RECAL_CNT_OFFSET			TCFG_FLOW_RECAL_TIME_OFFSET + TCFG_FLOW_RECAL_TIME_LENGTH	//0x08080106
#define TCFG_FLOW_RECAL_CNT_LENGTH			4												//recalibrationOverCnt	背景重计算累加器
#define TCFG_FLOW_BACK_SEC_OFFSET			TCFG_FLOW_RECAL_CNT_OFFSET + TCFG_FLOW_RECAL_CNT_LENGTH	//0x0808010A
#define TCFG_FLOW_BACK_SEC_LENGTH			4												//recalibrationBackSec	背景校准之后时间

#define TCFG_FLOW_WAIT_HEART_OFFSET		TCFG_FLOW_BACK_SEC_OFFSET + TCFG_FLOW_BACK_SEC_LENGTH		//0x0808010E
#define TCFG_FLOW_WAIT_HEART_LENGTH		4												//waitSendHeartbeatMin	心跳等待时间

#define TCFG_FLOW_MAG_SCANCNT_OFFSET		TCFG_FLOW_WAIT_HEART_OFFSET + TCFG_FLOW_WAIT_HEART_LENGTH	//0x08080112
#define TCFG_FLOW_MAG_SCANCNT_LENGTH		4												//MagnetismScanCnt		地磁扫描次数
#define TCFG_FLOW_CAR_NUMBER_OFFSET		TCFG_FLOW_MAG_SCANCNT_OFFSET + TCFG_FLOW_MAG_SCANCNT_LENGTH	//0x08080116
#define TCFG_FLOW_CAR_NUMBER_LENGTH		2												//CarNumber			车辆数

#define TCFG_FLOW_MAG_XBACK_OFFSET			TCFG_FLOW_CAR_NUMBER_OFFSET + TCFG_FLOW_CAR_NUMBER_LENGTH	//0x08080118
#define TCFG_FLOW_MAG_XBACK_LENGTH			2												//MagnetismBackX		地磁X轴背景值
#define TCFG_FLOW_MAG_YBACK_OFFSET			TCFG_FLOW_MAG_XBACK_OFFSET + TCFG_FLOW_MAG_XBACK_LENGTH	//0x0808011A
