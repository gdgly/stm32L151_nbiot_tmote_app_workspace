...
#define	SYSTEM_RTCCLOCK_TYPE			SYSTEM_RTCCLOCK_XTL_32768							//实时时钟

#define	SYSTEM_RTCPRIDI_DISABLE			0
#define	SYSTEM_RTCPRIDI_ENABLE			1
#define	SYSTEM_RTCPRIDI_TYPE			SYSTEM_RTCPRIDI_ENABLE								//周期中断
